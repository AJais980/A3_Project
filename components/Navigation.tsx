		...
		<>
			...
			>
				...
				>
					...
					<div className="absolute inset-0 bg-linear-to-r from-purple-500/10 via-blue-500/10 to-cyan-500/10 rounded-2xl opacity-50" />
							...
							<Link href="/" className="flex items-center space-x-2">
								<div className="relative">
									<motion.div
										...
										className="w-8 h-8 bg-linear-to-r from-purple-500 to-cyan-500 rounded-lg flex items-center justify-center"
									>
									...
									<motion.div
										...
										className="absolute inset-0 bg-linear-to-r from-purple-500/30 to-cyan-500/30 rounded-lg blur-md"
									/>
								</div>
								...
								>
									<Link href={item.href}>
										...
										>
											...
											{/* Gradient accent */}
											<div className={`absolute inset-0 bg-linear-to-r ${item.gradient} opacity-0 group-hover:opacity-25 rounded-xl transition-all duration-200 ease-out`} />
												...
												<Link href={`/profile/${dbUser.username}`}>
													...
													>
														...
														<motion.div
															animate={{ scale: [1, 1.2, 1] }}
															transition={{ duration: 2, repeat: Infinity }}
															className="absolute inset-0 rounded-full bg-linear-to-r from-purple-500/30 to-cyan-500/30 blur-sm"
														/>
													</motion.div>
												</Link>
											)}
										...
										>
											...
											<Link href="/signup">
												<motion.button
													whileHover={{ scale: 1.05 }}
													whileTap={{ scale: 0.95 }}
													className="px-4 py-2 bg-linear-to-r from-purple-500 to-cyan-500 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer"
												>
													Sign Up
												</motion.button>
											</Link>
										...
										{navItems.map((item, index) => (
											...
											>
												...
												>
													...
													>
														<div className={`p-2.5 rounded-lg bg-linear-to-r ${item.gradient} bg-opacity-20 group-hover:bg-opacity-30 transition-all duration-300`}>
												...
												>
													...
													<Link href="/signup" onClick={() => setIsMobileMenuOpen(false)}>
														<motion.button
															whileHover={{ scale: 1.02 }}
															whileTap={{ scale: 0.98 }}
															className="w-full p-4 bg-linear-to-r from-purple-500 to-cyan-500 text-white font-medium rounded-xl shadow-lg transition-all duration-300"
														>
															Sign Up
														</motion.button>
													</Link>
